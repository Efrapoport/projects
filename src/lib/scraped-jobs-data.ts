...
// Bundled as baseline data that seeds the job store on cold start.
// Live scrapers provide fresh data on top of this baseline.
// Dates are fixed ISO timestamps reflecting approximate original posting dates.
...
export const SCRAPED_JOBS: ScrapedJobRecord[] = [
  // ── Real postings from RemoteOK ──────────────────────────────────
  {
    ...
    source: "remoteok",
    detectedAt: "2026-02-16T09:30:00.000Z",
  },
  {
    ...
    source: "remoteok",
    detectedAt: "2026-02-14T15:00:00.000Z",
  },
  ...
  // ── Real postings from Indeed ────────────────────────────────────
  {
    ...
    source: "indeed",
    detectedAt: "2026-02-17T14:00:00.000Z",
  },
  {
    title: "Salesforce Administrator",
    ...
    url: "https://www.indeed.com/q-salesforce-administrator-jobs.html",
    source: "indeed",
    detectedAt: "2026-02-15T11:00:00.000Z",
  },
  {
  ...
  // ── Real postings from Greenhouse ────────────────────────────────
  {
    ...
    source: "greenhouse",
    detectedAt: "2026-02-13T08:00:00.000Z",
  },
  ...
  },
  {
    ...
    url: "https://www.linkedin.com/jobs/salesforce-administrator-jobs",
    source: "linkedin",
    detectedAt: "2026-02-16T16:00:00.000Z",
  },
  {
    title: "Senior Salesforce Administrator",
    company: "LogicGate",
    ...
    source: "linkedin",
    detectedAt: "2026-02-14T09:00:00.000Z",
  },
  ...
  // ── Real postings from Wellfound / Ashby ─────────────────────────
  {
    ...
    source: "wellfound",
    detectedAt: "2026-02-19T00:30:00.000Z",
  },
  {
    ...
    source: "wellfound",
    detectedAt: "2026-02-17T10:00:00.000Z",
  },
  ...
  // ── Real postings from Built In ──────────────────────────────────
  {
    ...
    source: "builtin",
    detectedAt: "2026-02-16T13:00:00.000Z",
  },
  ...
  // ── Real postings from Remote Rocketship ─────────────────────────
  {
    ...
    source: "remoteok",
    detectedAt: "2026-02-15T08:30:00.000Z",
  },
  {
    title: "Salesforce Administrator",
    company: "Smartsheet",
    ...
    source: "remoteok",
    detectedAt: "2026-02-14T11:00:00.000Z",
  },
  ...
  // ── Real postings from Startup Jobs ──────────────────────────────
  {
    ...
    url: "https://startup.jobs/roles/salesforce-admin",
    source: "startup.jobs",
    detectedAt: "2026-02-17T08:00:00.000Z",
  },
  {
    title: "Salesforce Administrator",
    company: "GoCardless",
    ...
    url: "https://startup.jobs/roles/salesforce-admin",
    source: "startup.jobs",
    detectedAt: "2026-02-13T14:00:00.000Z",
  },
  {
    title: "Salesforce Administrator",
    company: "Pushpay",
    ...
    url: "https://startup.jobs/roles/salesforce-admin",
    source: "startup.jobs",
    detectedAt: "2026-02-11T10:00:00.000Z",
  },
  ...
  // ── Real postings from Glassdoor ─────────────────────────────────
  {
    ...
    source: "glassdoor",
    detectedAt: "2026-02-18T16:00:00.000Z",
  },
  {
    ...
    source: "glassdoor",
    detectedAt: "2026-02-16T11:30:00.000Z",
  },
  ...
  // ── Real posting from Ziprecruiter ───────────────────────────────
  {
    ...
    source: "ziprecruiter",
    detectedAt: "2026-02-15T14:00:00.000Z",
  },
  ...
  // ── Additional real postings from Jobicy ─────────────────────────
  {
    ...
    source: "jobicy",
    detectedAt: "2026-02-17T12:00:00.000Z",
  },
  ...
  // ── Additional real postings from Arbeitnow ──────────────────────
  {
    ...
    source: "arbeitnow",
    detectedAt: "2026-02-14T16:00:00.000Z",
  },
  ...
  // ── Additional real postings from Himalayas ──────────────────────
  {
    ...
    source: "himalayas",
    detectedAt: "2026-02-13T10:00:00.000Z",
  },
];
